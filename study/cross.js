const field = {
    ...
    updateWin: function () {
        ...
        fetch(
            'http://192.168.64.2/api/update_res.php',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
    ...
    registration: function () {
        ...
        if(errors.length === 0){
            fetch(
                'http://192.168.64.2/api/registration.php',
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
             ...
             .then(res => this.loginStart(res, 'popup-registration'));
        }
    },
...
document.getElementById('registration')
        .addEventListener('click', event => {
            document.getElementById('popup-registration')
                    .setAttribute('style', 'display: flex');

            document.getElementById('popup-cross-registration')
                    .addEventListener('click', () => {
                        document.getElementById('popup-registration')
                                .setAttribute('style', '');
                    });
